export const skills = [
  ...
  },
  {
    ...
    meta: [
      { icon: '⚡', label: 'Aplica a', value: 'nora-video-ugc — paso de voz TTS' },
    ...
    rev: 'Rev: 2026-03-13',
    deps: '↓ alimenta a nora-video-ugc',
  ...
  },
  {
    ...
    meta: [
      { icon: '⚡', label: 'Aplica a', value: 'nora-video-ugc — paso de prompt de video' },
